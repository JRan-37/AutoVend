        ...
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 56, alignItems: "end" }}>
            ...
            <div style={{ position: "relative" }}>
              <div style={{ height: 520, display: "block", background: "var(--bg-2)", border: "1px solid var(--rule)", borderRadius: 12, overflow: "hidden" }}>
                <img src="assets/machine-scene.gif" alt="AutoVend SmartMart unit installed in a hotel lobby — animated scene" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
              </div>
          ...
          <div className="meta" style={{ marginTop: 56, display: "flex", justifyContent: "space-between" }}>
            ...
            <span>FIG · 01 — UNIT LV-4 · IN-VENUE INSTALL</span>
          </div>
        </div>
      </section>
